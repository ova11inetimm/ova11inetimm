                ...
                <div class='card'>
                    ...
                    <div class='card-body' style="text-align: center; margin-top: -10px;">
                        <video class="embed-responsive-item" width="830" height="500" controls preload>
                            <source src="../video/saludos/V_Saludos.mp4" type="video/mp4">
                            Your browser does not support the video tag.
                        </video>
                        <p style="margin-top: 5px;"><a href="https://cutt.ly/8JJnvbx">Video de tomado del canal de Youtube Amigo Mumu Español</a></p>
                    </div>
                </div>
            </div>
        </div>
